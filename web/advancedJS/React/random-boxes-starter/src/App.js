...
const Box = ({color}) => {
  // you can decide what props you want to take out of props object
  // will see this a lot in react stateless functions. Object destructuring
  const style = {
    height: '180px',
    width: '180px',
...
class App extends Component {
  constructor(props) {
    super(props);
    // array with 32 strings that represent color of each box
